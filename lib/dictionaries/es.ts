  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Plataforma de aprendizaje por voz impulsada por IA con speech recognition, TTS, traducción y flujos de trabajo con LLM para practicar escucha, pronunciación y comprensión en varios idiomas.",
      ...
      },
      {
        ...
        description:
          "Asistente de soporte basado en RAG que fundamenta las respuestas del LLM en el contenido de la base de conocimiento, con búsqueda semántica y flujos backend para ingesta de documentos, recuperación de contexto y generación de respuestas.",
        tags: ["RAG", "LLM", "Búsqueda Semántica", "Python"],
        github: "https://github.com/juma118",
        demo: "",
      },
    ],
